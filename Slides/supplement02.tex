...
% example 1: classic election studies
% actually have features of both panels and repeated cross-sections (the time-series element)
...
\frametitle{Panels vs. Repeated Cross-Section}
