...
\item Is the effect of this treatment larger or smaller than one from an earlier study with an effect size of Cohen's d = 0.40?
...
To convert $t$ to $d$, simply calculate: $\dfrac{2t}{\sqrt{df}}$, where $df$ is degrees of freedom, which is simply $n_1 + n_2 - 2$. In this case, this is simply:

\begin{equation}
d = \dfrac{2t}{\sqrt{df}} = \dfrac{2 * 1.76}{\sqrt{500+500-2}} = 0.11
\end{equation}
