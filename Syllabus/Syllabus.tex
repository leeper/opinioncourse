...
\clearpage
\subsection{Week 3: Survey and Questionnaire Methods (Jan. 29)}

This will cover both the process of measuring opinions and the principles of survey sampling methods.
...
We will discuss methods of macro opinion analysis
...
We will also cover experimental methods.
...
\clearpage
\subsection{Week 8: Motivated reasoning (Mar. 4)}
...
\clearpage
\subsection{Week 9: Heuristics and cognitive biases (Mar. 11)}
